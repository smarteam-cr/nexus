 ...
 *
 * GET lista · POST comparte · DELETE deja de compartir. Los TRES son de quien administra la
 * sección: dirección **y el CSL** (`guardRolesAdmin` → `esAdminDeRoles`, 2026-09-23). Lo que
 * otorgan es LECTURA: a quien recibe el share no lo convierte en administrador — no edita,
 * no borra y no re-comparte.
 *
