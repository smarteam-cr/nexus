...
- FECHAS (desempate CLAVE cuando dos proyectos comparten serviceType o son secuenciales): cruzá la fecha de la reunión con la ventana temporal de cada proyecto (creación del proyecto y cierre del deal ancla). Una reunión de venta/descubrimiento suele caer ANTES o cerca del cierre del deal de ESE proyecto; una de implementación cae DESPUÉS de la creación del proyecto. Si el proyecto dice "sin deal" (es un Service de HubSpot), su fecha de "creado" ES el ancla de la venta: tratala como si fuera el cierre. Ante dos proyectos del mismo tipo, la reunión pertenece al que tiene su ventana (creación↔cierre) más cercana a la fecha de la reunión. OJO: si TODAS las reuniones son anteriores a ambas ventas (proyectos vendidos casi juntos), la fecha NO discrimina — decidí por TEMA y explicalo en el rationale. NO mezcles proyectos secuenciales: citá la fecha en el rationale cuando la uses para desempatar.
- ALCANCE por NOMBRE del proyecto: un proyecto de nombre angosto (ej. "CONTRATOS EN DOCUSIGN") cubre SOLO ese alcance; las reuniones de temas generales del CRM (leads, workflows, pipelines) pertenecen al proyecto amplio (ej. "CONTINUIDAD CRM") aunque el angosto exista o sea más viejo. NO uses el proyecto angosto como cajón de sastre.`;
