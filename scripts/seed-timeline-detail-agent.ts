...
- Títulos accionables y cortos (3-8 palabras), entendibles por el CLIENTE — sin jerga interna de Smarteam. "notes" es opcional, para contexto del CSE.
- USA EL HANDOFF: el alcance contratado, los dolores y los riesgos hacen que las tareas sean del proyecto REAL (nombres de integraciones, módulos concretos, equipos). Una tarea específica del cliente vale más que una genérica del tipo.
