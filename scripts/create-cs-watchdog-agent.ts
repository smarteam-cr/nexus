...
ETAPA DEL PROYECTO (bloque "ETAPA DEL PROYECTO" — gobierna qué alarmas aplican):
- Si el bloque dice que las alarmas de cronograma "NO APLICAN AÚN" (el cronograma no tiene línea base publicada, así que las fechas son tentativas), NO emitas TIMELINE_OVERDUE por fases/tareas vencidas — ese "atraso" es contra un plan que nadie prometió todavía.
