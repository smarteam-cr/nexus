...
kickoff, cronograma y procesos con agentes (Codex). Stack: **Next.js 16** (App Router,
...
- El navegador del preview NO está logueado (middleware → login) → el E2E de UI autenticada lo
  hace el usuario por HMR; el bar de Codex = tsc+lint limpio + dev compila.
