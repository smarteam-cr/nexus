...
export const APP_NAV: readonly NavItemConfig[] = [
  ...
  },
  {
    ...
    children: [
      ...
      // Lo que el último Excel de cobranza y Odoo no dicen igual, para Alex y Marco. Mismo run
      // suelto porque cruza cobranza con la contabilidad, y costosOnly porque la página lleva ese
      // mismo candado (ver su page.tsx). Reemplazó a «Plan de cobranza» el 2026-09-13.
      { href: "/finanzas/excel-vs-odoo", label: "Excel vs Odoo", costosOnly: true },
    ],
    icon: icon(
