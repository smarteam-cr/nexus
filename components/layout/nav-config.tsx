...
export const APP_NAV: readonly NavItemConfig[] = [
  ...
  },
  {
    ...
    children: [
      ...
      // El resumen del plan de cobranza para Alex y Marco: qué cambió, qué falta y qué espera una
      // decisión. Mismo run suelto porque cruza cobranza con los números de Dirección, y
      // costosOnly porque la página lleva ese mismo candado (ver su page.tsx).
      { href: "/finanzas/plan-de-cobranza", label: "Plan de cobranza", costosOnly: true },
    ],
    icon: icon(
