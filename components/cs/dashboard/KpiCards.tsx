...
export default function KpiCards({
  ...
  const cards: Array<{
    ...
    {
      value: counters.delayedHs,
      label: "Retrasados / en riesgo",
      tone: "text-red-600 border-red-500/25 bg-red-500/5",
      source: { label: "HubSpot", date: freshness.stageSyncedAt },
    },
    {
      value: counters.overdueTimeline,
    ...
    // Card de partner (confidencial) — solo para roles con acceso.
    ...(partnerVisible
      ? [{
          value: counters.renewals90d,
          label: "Renovaciones ≤90 días",
          tone: "text-purple-600 border-purple-500/25 bg-purple-500/5",
          source: freshness.partnerSupported
            ? { label: "HubSpot Partner", date: freshness.partnerFetchedAt }
            : { label: "sin permiso de partner", missing: true },
        }]
      : []),
  ];
