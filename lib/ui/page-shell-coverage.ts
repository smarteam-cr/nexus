...
export const PAGE_SHELL_COVERAGE: Record<string, ShellDecl> = {
  ...
  "finanzas/costos/planillas/historial": { shell: "SHELL_DEFAULT" },
  "finanzas/costos/planillas/calendario": { shell: "SHELL_DEFAULT" },
  "finanzas/costos/aguinaldo": { shell: "SHELL_DEFAULT" },
  ...
  "finanzas/plan-de-cobranza": { shell: "SHELL_DEFAULT" },
  ...
  settings: { shell: "SHELL_DEFAULT" },
  "integrations/odoo": { shell: "SHELL_DEFAULT" },
